    ...
    return (
      <nav aria-label={t("back")} className="mb-8 flex min-w-0 max-w-full items-center">
        <button
          type="button"
          onClick={() => router.back()}
          className="inline-flex shrink-0 items-center gap-1 rounded-lg border border-black/10 bg-card px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-card"
        >
