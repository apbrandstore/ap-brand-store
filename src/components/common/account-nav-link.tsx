...
export function AccountNavLink({ variant }: AccountNavLinkProps) {
  ...
  const link = (
    <Link
      ...
      className={
        variant === "mobile"
          ? "inline-flex h-10 w-10 shrink-0 items-center justify-center border-0 bg-transparent p-0 text-white transition-transform duration-150 hover:scale-[1.06] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/80 md:hidden"
